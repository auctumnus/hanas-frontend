...
import { type ThrownKratosError } from '@hanas-app/api-helper'
...
const onSubmit = async () => {
  ...
  client.register(email, username, password.value)
    .catch((e: ThrownKratosError) => {
      console.error(e)
...
<template>
  <div class="container">
    ...
    <hr>
    <p>
      <span>Already have an account?</span> <router-link to="sign-in">
        Sign in
      </router-link>
    </p>
  </div>
